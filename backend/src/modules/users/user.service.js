...
function normalizeProfile(user) {
        return {
                ...
                monthlyMileage: user.monthlyMileage || null,
...
async function updateMileage(userId, monthlyMileage) {
        const user = await prisma.user.update({
                where: { id: userId },
                data: { monthlyMileage: monthlyMileage ? parseInt(monthlyMileage, 10) : null },
                select: {
                        id: true,
                        fullName: true,
                        email: true,
