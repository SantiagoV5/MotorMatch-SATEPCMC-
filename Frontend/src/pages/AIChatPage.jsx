 ...
 * Sigue el patrón de páginas existentes: Header compartido + contenido propio.
 */
...
export default function AIChatPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fc] font-body text-on-surface flex flex-col">
      ...
      {/* ── Layout del chat: ocupa el alto restante ── */}
            ...
            <div className="max-w-3xl mx-auto">
              ...
              {!isEmpty && !isLoading && (
                <div className="flex gap-2 mb-3 overflow-x-auto pb-1 no-scrollbar">
                  {['Compara estas motos', '¿Cuál gasta menos?', 'Ver opciones de financiamiento', 'Costos de mantenimiento'].map((chip) => (
                    <button
                      key={chip}
                      ...
                      className="whitespace-nowrap px-3 py-1.5 rounded-full bg-white border border-slate-200
                                 ...
                                 hover:border-primary/30 hover:text-primary hover:bg-slate-50 transition-all flex-shrink-0"
                    >
                      {chip}
                    </button>
                  ))}
              ...
              >
                ...
                <textarea
                  ...
                  placeholder="Pregúntame sobre motos en Colombia…"
                  rows={1}
                ...
                {/* Contador de caracteres (visible al acercarse al límite) */}
                ...
                <button
                  ...
                  style={{
                    backgroundColor:
                      !inputValue.trim() || isLoading ? '#e2e8f0' : '#FF6B35',
                    color: !inputValue.trim() || isLoading ? '#94a3b8' : '#fff',
                  }}
                  title="Enviar (Enter)"
                >
                  {isLoading ? (
